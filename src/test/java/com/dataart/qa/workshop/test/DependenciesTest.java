...
public class DependenciesTest {
    @Test
    public void dependencies_with_multiplication_test() {
        System.out.println("Multiplication test.");
        Assert.assertEquals("Multiplication result is wrong", 10, 2 * 5);
    }

    @Test
    public void dependencies_with_division_test() {
        System.out.println("Division test.");
        Assert.assertEquals(2.0, 10 / 5.0, 0);
    }

    @Test
    public void dependencies_with_boolean_test() {
    ...
    @Test
    public void dependencies_with_fail_test() {

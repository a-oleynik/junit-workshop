...
public class ExecutionOrderWithTest {
    @Test
    void execution_order_with_fail_test() {
    ...
    @Test
    @Order(3)
    void execution_order_with_multiplication_test() {
    ...
    @Test
    @Order(1)
    void execution_order_with_division_test() {
    ...
    @Test
    @Order(2)
    void execution_order_with_boolean_test() {

 ...
 */
public class BeforeClassSecondCase {

    @BeforeClass
    public static void beforeClass() {
        System.out.println("[BeforeClass] BeforeClassSecondCase — class setup");
    }

    @AfterClass
    public static void afterClass() {
        System.out.println("[AfterClass] BeforeClassSecondCase — class teardown");
    }

    @Test
    public void first_test_in_second_case() {
        System.out.println("Running first test in BeforeClassSecondCase");
    }

    @Test
    public void second_test_in_second_case() {
        System.out.println("Running second test in BeforeClassSecondCase");
    }
}

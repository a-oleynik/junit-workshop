...
|---------------------------------------------------------------------------------|----------------------|----------------------------------------------------------|
| [`master`](https://github.com/a-oleynik/junit-workshop/tree/master)             | **JUnit 6** (6.1.2)  | Current branch — latest JUnit 6 features                 |
...
| `junit-platform-suite`              | `6.1.2` *(BOM)* | `@Suite`, `@SelectClasses`, `@BeforeSuite`, `@AfterSuite`                                                                                          |

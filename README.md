...
|---------------------------------------------------------------------------------|----------------------|----------------------------------------------------------|
| [`master`](https://github.com/a-oleynik/junit-workshop/tree/master)             | **JUnit 6** (6.1.1)  | Current branch — latest JUnit 6 features                 |
...
|-------------------------------------|-----------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
| `junit-jupiter-engine`              | `6.1.1` *(BOM)* | Test engine — discovers and runs Jupiter tests; transitively provides `junit-jupiter-api` (all `@Test`, `@BeforeEach`, `@AfterAll`, … annotations) |
| `junit-jupiter-params`              | `6.1.1` *(BOM)* | `@ParameterizedTest`, `@ValueSource`, `@CsvSource`, `@MethodSource`, `@CsvFileSource`                                                              |
| `junit-platform-suite`              | `6.1.1` *(BOM)* | `@Suite`, `@SelectClasses`, `@BeforeSuite`, `@AfterSuite`                                                                                          |

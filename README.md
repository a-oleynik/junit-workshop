...
[![JUnit](https://img.shields.io/badge/JUnit-6.1.3-green.svg)](https://junit.org/)
...
|---------------------------------------------------------------------------------|----------------------|----------------------------------------------------------|
| [`master`](https://github.com/a-oleynik/junit-workshop/tree/master)             | **JUnit 6** (6.1.3)  | Current branch — latest JUnit 6 features                 |
...
|-------------------------------------|-----------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
| `junit-jupiter-engine`              | `6.1.3` *(BOM)* | Test engine — discovers and runs Jupiter tests; transitively provides `junit-jupiter-api` (all `@Test`, `@BeforeEach`, `@AfterAll`, … annotations) |
| `junit-jupiter-params`              | `6.1.3` *(BOM)* | `@ParameterizedTest`, `@ValueSource`, `@CsvSource`, `@MethodSource`, `@CsvFileSource`                                                              |
| `junit-platform-suite`              | `6.1.3` *(BOM)* | `@Suite`, `@SelectClasses`, `@BeforeSuite`, `@AfterSuite`                                                                                          |
